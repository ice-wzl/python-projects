#This project will create a calculator
#Libraries
from tkinter import *
...
def equal_pressed():
    try:
        ...
        expression_field_value.set("You cannot divide by zero!")
...
if __name__ == '__main__':
    ...
    for row, buttons in enumerate(button_rows):
        for col, button_value in enumerate(buttons):
            ...
            button1 = Button(window, text=button_value, height=3, width=3, borderwidth=2, command=when_pressed)
